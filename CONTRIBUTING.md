...
Read `AGENTS.md` first; it applies to human and AI contributors. Then choose an
open issue with a bounded outcome or propose one before beginning a substantial
change.
